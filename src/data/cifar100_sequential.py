...
class CIFAR100SequentialDataModule:
    """DataModule for sequential task learning on CIFAR100."""
    ...
    def __init__(
        ...
        """Initialize CIFAR100 DataModule.
        ...
        # Default CIFAR100 normalization for stability and faster training (parameters do not have to be changed as much)
        ...
        # Default tasks: 5 tasks with 20 classes each
        if tasks is None:
            tasks = {
                'A': list(range(0, 20)),
                'B': list(range(20, 40)),
